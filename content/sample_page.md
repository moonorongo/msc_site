---
Title: Sample page
Description: meta description in meta, and below (see first paragraph).
social:
    - title: Visit us on GitHub
      url: https://github.com/moonorongo
      icon: octocat
    ...
    - title: Join us on Freenode IRC Webchat
      ...
      icon: chat
author: Mauro Cifuentes      
---

## %site_title% - %meta.title%

Text here, there are a  [link description](http://link_url.com/).
...
More text, `emphasized` text.

Another paragraph - detected with empty new-line

next, some `CRUDE` html:
...
### Some images
![A dude spritesheet](%base_url%/assets/images/dude.png)
